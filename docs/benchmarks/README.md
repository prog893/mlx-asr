...
| [quantization.md](quantization.md) | weight and KV precision | Costs accuracy monotonically in bit width, reversing the earlier single-clip tie. 4-bit is last of five: 1.07 points behind 8-bit, 1.30 behind fp16. 8-bit matches fp16 at 7.3GB and full speed. `--kv-bits 8` is close to free. |
