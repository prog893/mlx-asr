...
(scripts/benchmarks/probes/probe_seam_errors.py).
...
discarded. Cost is proportional extra decode steps: overlap/chunk_len more work.
    ...
    uv run python scripts/benchmarks/sweep_overlap.py --reference ref.srt \
...
from metrics.eval_cer import cer, load_text, normalize
