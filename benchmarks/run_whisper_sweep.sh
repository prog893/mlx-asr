...
#
# Ordered cheapest-first from benchmarks/probe_whisper_speed.py, so a failure
...
CORPUS="${1:-corpus}"
NARR_WAV="${2:-0816_16k.wav}"
NARR_SRT="${3:-0816_online_narration_jpn.srt}"
...
# it through the wrong runner cost 68 points. See benchmarks/run_kotoba_hf.py.
